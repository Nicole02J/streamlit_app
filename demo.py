...
with tab1:
    ...
    st.title("Dashboard de Residuos Municipales del Perú")

    st.markdown("""
    ## Introducción

    Este proyecto presenta un análisis de la generación de residuos
    municipales en el Perú.

    Se utilizan datos por departamento, provincia y distrito para
    evaluar la producción de residuos domiciliarios y no domiciliarios.

    ### Objetivos

    - Analizar la generación de residuos municipales.
    - Comparar residuos domiciliarios y no domiciliarios.
    - Evaluar la distribución de la población urbana y rural.
